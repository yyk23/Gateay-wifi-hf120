...
void rx_wpa_1_of_4 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
void tx_wpa_2_of_4 (struct wpa_common_ctx *ctx);
int rx_wpa_3_of_4 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
void tx_wpa_4_of_4 (struct wpa_common_ctx *ctx);
int rx_wpa_1_of_2 (struct wpa_common_ctx *ctx, struct eapol_key_pkt *eapol_key);
...
void init_wpa_ctx(struct wpa_common_ctx *ctx, IEEE80211STATUS *conf);
void init_AP_wpa_ctx(struct wpa_common_ctx *ctx, IEEE80211STATUS *conf);
U8 sec80211_detect(struct wpa_common_ctx *ctx, U8 *buf, U16 buf_len);
