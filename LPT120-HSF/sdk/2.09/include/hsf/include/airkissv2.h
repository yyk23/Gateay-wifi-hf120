...
/*
 * Hi-Flying own interface
 */
void airkissv2_init(void);
void airkissv2_set_key(char *key);
void airkissv2_reset(void);
int airkissv2_fix_channel(uint8_t channel, uint8_t *bssid);
void airkissv2_finish(void);
int HSF_API hfnet_start_airlink(char *device_type, char *device_id);
void HSF_API hfnet_stop_airlink();
