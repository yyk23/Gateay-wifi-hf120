...
/**
 * @brief Socket join into the group address. 
 * @param socket		[IN] Socket number of the connection.
 * @param groupaddr		[IN] The group IP address would like to join.
 * @return -1 : Join group fail. 0 : Join group successful.
 */
int udpjointgroup(NETSOCKET socket, uip_ipaddr_t *groupaddr);
